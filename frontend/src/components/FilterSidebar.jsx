...
// function FilterSidebar({allProducts}) {
//     const Categoris = allProducts.map(p=> p.category)
//     const UniqueCategory =["All", ...new Set(Categoris)]
...
//   return (
//     <div className='rounded-md hidden md:block w-64'>
//       {/* search */}
//       <Input type='text' placeholder='Search' className="bg-white p-2 rounded-md border-2 "/>
//       {/* category */}
...
//       <Select className='bg-white w-full p-2 broder-gray-200 border-2 rounded-md '>
//         {
...
// function FilterSidebar({ allProducts,priceRange }) {
...
//                 type='text' 
//                 placeholder='Search' 
//                 className="bg-white p-2 rounded-md border-2 focus:outline-none focus:border-gray-900" 
//             />
...
//             {/* brand - Native Select Dropdown (like in image) */}
//             <h1 className='mt-5 font-semibold text-xl'>Brand</h1>
//             <select 
...
//                   <Input type="number" min='0' max='5000' className='w-20 border-2 border-gray-300 rounded'  />
//                   <span>-</span>
//                   <Input type="number" min='0' max='9999999' className='w-20 border-2 border-gray-300 rounded'  />
//               </div>
//                   <Input type='range' min='0' max='5000' step="100" className='w-ful'/>
//                   <Input type='range' min='0' max='9999999' step="100" className='w-ful'/>
//             </div>
//             {/* Reset Button  */}
//                 <Button className='mt-5 w-full bg-gray-900 hover:bg-blue-700 text-white px-8 py-2 rounded-md font-medium transition-all active:scale-95 disabled:opacity-70 cursor-pointer'>Reset Filter</Button>
